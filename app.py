...
def venues():
    ...
    for venue in venues:
        print(venue)
        locations.add(venue.city, venues.state)
...
def search_venues():
    ...
    venue_list = list(map(Venue.short, venue_search))
    response = {
        "count": len(venue_list),
        "data": venue_list
    }
    return render_template('pages/search_venues.html', results=response,
                           search_term=request.form.get('venue_search', ''))
...
def show_venue(venue_id):
    ...
    data = {
        ...
        "upcoming_shows": upcoming_shows,
        "previous_shows_count": len(previous_shows),
