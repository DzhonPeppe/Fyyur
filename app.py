...
def search_venues():
    ...
    results = Venue.query.filter(Venue.name.ilike(f'%{search_query}%'))
    response = {
        "count": results.count(),
        "data": results
    }
...
def show_artist(artist_id):
    ...
    data = {
        ...
        "previous_shows": past_shows,
        "upcoming_shows": upcoming_shows,
        "previous_shows_count": len(past_shows),
        "upcoming_shows_count": len(upcoming_shows)
    }
...
def edit_artist_submission(artist_id):
    ...
    try:
        ...
        flash('An error has occurred. Update was not successful. Please try again.')
        db.session.rollback()
